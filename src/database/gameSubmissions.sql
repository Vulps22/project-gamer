...
ALTER TABLE `gameSubmissions`
  ...
  MODIFY COLUMN `id` int NOT NULL AUTO_INCREMENT COMMENT 'Internal unique identifier for the submission record.',
  MODIFY COLUMN `url` text NOT NULL COMMENT 'The URL of the game store page submitted by the user.',
